...
namespace ua.org.gdg.devfest
{
    public class UnityIPhoneXSupport
    {
        ...
        private const float footerSize = 0f;
        private static readonly Color headerColor = new Color(0.07450981f, 0.1019608f, 0.1254902f, 1.0f);
        private static readonly Color footerColor = new Color(1.0f, 1.0f, 1.0f, 1.0f);
        private const string headerImage = ""; // Relative path from "Assets/StreamingAssets/"
        private const string footerImage = ""; // Relative path from "Assets/StreamingAssets/"
        ...
        public static void OnPostProcessBuild(BuildTarget buildTarget, string path)
        {
            ...
            {
                string headerImageText =
                    "        NSString *headerImagePath = [[NSBundle mainBundle] pathForResource:@\"Data/Raw/{0}\" ofType:nil];\n" +
            ...
            {
                string footerImageText =
                    "        NSString *footerImagePath = [[NSBundle mainBundle] pathForResource:@\"Data/Raw/{0}\" ofType:nil];\n" +
